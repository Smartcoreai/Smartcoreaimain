...
const REVIEWS = [
  {
    ...
    rating: 5,
    text: "Ekspedenten set up our chatbot in 2 days. It now handles 60% of our customer questions automatically. My team finally has time to focus on actual work.",
    avatar: "SM",
    date: "2 weeks ago",
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    text: "Tried other AI tools before — none of them worked for a small business like mine. Ekspedenten actually listened to what I needed and delivered.",
    avatar: "PS",
    date: "2 months ago",
  },
  {
