...
export const translations = {
  en: {
    ...
    calculator: {
      ...
      heroHook: "How many new patients are you losing to competitors today?",
      heroParagraph: "38% of calls to dental clinics go unanswered — and 65% of those are new patients. They call once. Don't get through. Call the competitor.",
      heroCta: "See what you could save →",
      heroBox1Label: "LOST REVENUE PER MONTH",
      heroBox1Sub: "in lost new patient inquiries",
      heroBox2Label: "POTENTIAL LOST LIFETIME VALUE (LTV)",
      heroBox2Sub: "conservative estimate (5-year LTV)",
  ...
  no: {
    ...
    calculator: {
      ...
      heroHook: "Hvor mange nye pasienter mister du til konkurrentene i dag?",
      heroParagraph: "38% av anropene til tannklinikker går ubesvart — og 65% av de ubesvarte er nye pasienter. De ringer én gang. Får ikke svar. Ringer konkurrenten.",
      heroCta: "Se hva du kan spare →",
      heroBox1Label: "TAPT INNTEKT PER MÅNED",
      heroBox1Sub: "i tapte nye pasienthenvendelser",
      heroBox2Label: "POTENSIELT TAPT LIVSTIDSVERDI (LTV)",
      heroBox2Sub: "konservativt estimat (5-års LTV)",
