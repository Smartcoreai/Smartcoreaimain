      ...
      <div className="wrap">
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 className="text-[22px] sm:text-4xl lg:text-[56px]" style={{
            ...
            fontWeight: 700, fontStyle: "normal", color: "#F5F0E8", letterSpacing: "-0.01em", marginBottom: 14, lineHeight: 1.05,
          }}>
            {t.contact.headline1}{" "}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, maxWidth: 920, margin: "0 auto" }} className="contact-grid">
          ...
          <div style={{
            ...
            <div>
              <h3 className="text-lg md:text-[22px]" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 800, fontStyle: "normal", color: "#F5F0E8", marginBottom: 8, letterSpacing: "-0.02em" }}>
          ...
          <div style={{ background: "rgba(15,15,20,0.7)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 24, padding: 36 }}>
            {sent ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: 16, textAlign: "center" }}>
                ...
                <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 22, fontWeight: 700, fontStyle: "normal", color: "#F5F0E8" }}>{t.contact.successTitle}</div>
