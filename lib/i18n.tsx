...
export const translations = {
  en: {
    ...
    aiStats: {
      ...
      stats: [
        ...
        },
        {
          ...
          context: "Ekspedenten captures and qualifies leads 24/7",
        },
        {
          value: "7 days",
          countTo: 7,
    ...
    about: {
      ...
      story: {
        ...
        paragraphs: [
          ...
          "Today we build the Ekspedenten AI receptionist for Norwegian dental clinics — handling inbound calls, booking and lead qualification 24/7.",
    ...
    pricingStandard: {
      heroTitle: "One package. Clear pricing.",
      ...
      period: "/mo",
      priceClarification: "Regular price kr 10,000/mo after the founding window. Founding price locked for 12 months from signing.",
      setupLabel: "Setup",
      setupValue: "kr 7,500 one-time",
      commitmentLabel: "Commitment",
      commitmentValue: "3 months, then monthly",
      includesHeading: "Included",
      includes: [
        "AI handling inbound calls 24/7",
        "Booking directly in Opus, Muntra or Anita",
        "SMS confirmation to the patient",
        "Dashboard at app.ekspedenten.no",
        "Hands-on training from Henrik / Aleksander the first week",
      ],
      guaranteesHeading: "Guarantees",
      guarantees: [
      ...
      ctaSecondary: "See the full package →",
      footnote: "All prices exclude VAT.",
    },
  },
  ...
  no: {
    ...
    aiStats: {
      ...
      stats: [
        ...
        },
        {
          ...
          context: "Ekspedenten fanger og kvalifiserer leads 24/7",
        },
        {
          value: "7 dager",
          countTo: 7,
    ...
    about: {
      ...
      story: {
        ...
        paragraphs: [
          ...
          "I dag bygger vi Ekspedenten — AI-resepsjonisten for norske tannklinikker som tar inngående anrop, booker og kvalifiserer leads 24/7.",
    ...
    pricingStandard: {
      ...
      foundingPrice: "kr 6 900",
      period: "/mnd",
      priceClarification: "Ordinær pris kr 10 000/mnd etter founding-vinduet. Founding-pris låst i 12 måneder fra signering.",
      setupLabel: "Oppstart",
      setupValue: "kr 7 500 engangs",
      commitmentLabel: "Binding",
      commitmentValue: "3 måneder, deretter månedlig",
      includesHeading: "Inkludert",
      includes: [
      ...
      ctaSecondary: "Se hele pakken →",
      footnote: "Alle priser eksklusive mva.",
    },
  },
} as const;
