...
export const translations = {
  en: {
    ...
    calculator: {
      ...
      backLink: "← Back",
      labelRecovery: "Daily share of missed calls at the clinic",
      hintRecovery: "Industry data shows clinics typically miss 25–35% of daily calls. Adjust for your situation.",
  ...
  no: {
    ...
    calculator: {
      ...
      backLink: "← Tilbake",
      labelRecovery: "Daglig andel tapte anrop i klinikken",
      hintRecovery: "Bransjedata viser at klinikker typisk taper 25–35% av daglige anrop. Juster for din situasjon.",
