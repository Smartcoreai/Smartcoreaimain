...
export default function ObjectionsPage() {
  return (
    <>
      <Navbar />
      <main style={{ background: "#08080c", minHeight: "100vh" }}>
        {/* Hero */}
        <section style={{ padding: "140px 24px 80px", textAlign: "center", position: "relative" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{ fontSize: "clamp(15px,2vw,18px)", color: "#8888a0", maxWidth: 520, margin: "0 auto", lineHeight: 1.7 }}>
              ...
              >
                <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 15, color: "#8888a0", lineHeight: 1.75, margin: 0 }}>
                      {item.a}
                    </p>
                  </div>
                </div>
        ...
        <section style={{ padding: "20px 24px 120px", textAlign: "center" }}>
          <div style={{
            ...
            background: "linear-gradient(135deg, rgba(168,85,247,0.10), rgba(34,211,238,0.05))",
            ...
            <p style={{ fontSize: 15, color: "#8888a0", lineHeight: 1.7, marginBottom: 28 }}>
