    ...
    <section className="lp-section" id="how">
      <div className="lp-container">
        <div className="lp-section-header">
          <span className="lp-label">Slik funker det</span>
          <h2>Vi tar oss av oppsett og opplæring som en del av avtalen.</h2>
